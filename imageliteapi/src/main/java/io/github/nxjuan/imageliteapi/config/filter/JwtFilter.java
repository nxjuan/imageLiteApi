package io.github.nxjuan.imageliteapi.config.filter;

import io.github.nxjuan.imageliteapi.application.jwt.InvalidTokenException;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException{
        ...
        if(token != null){
            try {
                ...
                log.error("Token na validação do token: {}", e.getMessage());
            }
        }
